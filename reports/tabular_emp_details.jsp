...
<report name="tabular_emp_details" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL JOBS.JOB_TITLE, EMP_DETAILS_VIEW.EMPLOYEE_ID, EMP_DETAILS_VIEW.JOB_ID, EMP_DETAILS_VIEW.MANAGER_ID, EMP_DETAILS_VIEW.DEPARTMENT_ID, 
EMP_DETAILS_VIEW.LOCATION_ID, EMP_DETAILS_VIEW.COUNTRY_ID, 
EMP_DETAILS_VIEW.LAST_NAME || ' ' ||  EMP_DETAILS_VIEW.FIRST_NAME full_name, EMP_DETAILS_VIEW.SALARY, 
EMP_DETAILS_VIEW.COMMISSION_PCT, EMP_DETAILS_VIEW.DEPARTMENT_NAME, EMP_DETAILS_VIEW.JOB_TITLE, EMP_DETAILS_VIEW.CITY, EMP_DETAILS_VIEW.STATE_PROVINCE, 
EMP_DETAILS_VIEW.COUNTRY_NAME, EMP_DETAILS_VIEW.REGION_NAME
FROM EMP_DETAILS_VIEW, JOBS ]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_JOB_TITLE">
        <displayInfo x="1.08435" y="1.94995" width="1.83142" height="1.62695"
        />
        <dataItem name="full_name" datatype="vchar2" columnOrder="26"
         width="46" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Full Name">
          <dataDescriptor
           expression="EMP_DETAILS_VIEW.LAST_NAME || &apos; &apos; || EMP_DETAILS_VIEW.FIRST_NAME"
           descriptiveExpression="FULL_NAME" order="8" width="46"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JOB_TITLE" datatype="vchar2" columnOrder="11"
         width="35" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Job Title">
          <dataDescriptor expression="JOBS.JOB_TITLE"
           descriptiveExpression="JOB_TITLE" order="1" width="35"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPARTMENT_ID" oracleDatatype="number"
         ...
         defaultHeight="10000" columnFlags="33" defaultLabel="Department Id">
          <dataDescriptor expression="EMP_DETAILS_VIEW.DEPARTMENT_ID"
           descriptiveExpression="DEPARTMENT_ID" order="5"
           oracleDatatype="number" width="22" precision="4"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LOCATION_ID" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="60000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Location Id">
          <dataDescriptor expression="EMP_DETAILS_VIEW.LOCATION_ID"
           descriptiveExpression="LOCATION_ID" order="6"
           oracleDatatype="number" width="22" precision="4"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTRY_ID" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="17" width="2"
         defaultWidth="20000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Country Id">
          <dataDescriptor expression="EMP_DETAILS_VIEW.COUNTRY_ID"
           descriptiveExpression="COUNTRY_ID" order="7"
           oracleDatatype="aFixedChar" width="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="18"
         ...
         columnFlags="33" defaultLabel="Salary">
          <dataDescriptor expression="EMP_DETAILS_VIEW.SALARY"
           descriptiveExpression="SALARY" order="9" oracleDatatype="number"
           width="22" scale="2" precision="8"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COMMISSION_PCT" oracleDatatype="number"
         columnOrder="19" width="22" defaultWidth="40000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Commission Pct">
          <dataDescriptor expression="EMP_DETAILS_VIEW.COMMISSION_PCT"
           descriptiveExpression="COMMISSION_PCT" order="10"
           oracleDatatype="number" width="22" scale="2" precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEPARTMENT_NAME1" datatype="vchar2" columnOrder="20"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Department Name1">
          <dataDescriptor expression="EMP_DETAILS_VIEW.DEPARTMENT_NAME"
           descriptiveExpression="DEPARTMENT_NAME" order="11" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JOB_TITLE1" datatype="vchar2" columnOrder="21"
         width="35" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Job Title1">
          <dataDescriptor expression="EMP_DETAILS_VIEW.JOB_TITLE"
           descriptiveExpression="JOB_TITLE" order="12" width="35"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="CITY" datatype="vchar2" columnOrder="22" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="City">
          <dataDescriptor expression="EMP_DETAILS_VIEW.CITY"
           descriptiveExpression="CITY" order="13" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="STATE_PROVINCE" datatype="vchar2" columnOrder="23"
         ...
         columnFlags="33" defaultLabel="State Province">
          <dataDescriptor expression="EMP_DETAILS_VIEW.STATE_PROVINCE"
           descriptiveExpression="STATE_PROVINCE" order="14" width="25"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COUNTRY_NAME" datatype="vchar2" columnOrder="24"
         ...
         columnFlags="33" defaultLabel="Country Name">
          <dataDescriptor expression="EMP_DETAILS_VIEW.COUNTRY_NAME"
           descriptiveExpression="COUNTRY_NAME" order="15" width="40"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="REGION_NAME" datatype="vchar2" columnOrder="25"
         width="25" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Region Name">
          <dataDescriptor expression="EMP_DETAILS_VIEW.REGION_NAME"
           descriptiveExpression="REGION_NAME" order="16" width="25"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="EMPLOYEE_ID" oracleDatatype="number" columnOrder="12"
         ...
         defaultLabel="Employee Id">
          <dataDescriptor expression="EMP_DETAILS_VIEW.EMPLOYEE_ID"
           descriptiveExpression="EMPLOYEE_ID" order="2"
           oracleDatatype="number" width="22" precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="JOB_ID" datatype="vchar2" columnOrder="13"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Job Id">
          <dataDescriptor expression="EMP_DETAILS_VIEW.JOB_ID"
           descriptiveExpression="JOB_ID" order="3" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="MANAGER_ID" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="80000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Manager Id">
          <dataDescriptor expression="EMP_DETAILS_VIEW.MANAGER_ID"
           descriptiveExpression="MANAGER_ID" order="4"
           oracleDatatype="number" width="22" precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountJOB_TITLEPerReport" source="SALARY" function="sum"
  ...
  <section name="main">
    <body>
      <frame name="M_G_JOB_TITLE_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.50000" height="0.87500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <frame name="M_G_JOB_TITLE_HDR">
          ...
          <text name="B_DEPARTMENT_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.06250" y="0.00000" width="0.50000"
             height="0.12500"/>
          ...
          <text name="B_LOCATION_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.56250" y="0.00000" width="0.50000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
          ...
          <text name="B_LAST_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.43750" y="0.00000" width="0.37500"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
          ...
          <text name="B_SALARY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.25000" y="0.00000" width="0.75000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
          ...
          <text name="B_COMMISSION_PCT" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.00000" y="0.00000" width="0.62500"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
               textColor="r100g100b100"/>
              <string>
              <![CDATA[Commission Pct]]>
              </string>
            </textSegment>
          </text>
          <text name="B_DEPARTMENT_NAME1" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.62500" y="0.00000" width="0.68750"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
               textColor="r100g100b100"/>
              <string>
              <![CDATA[Department Name1]]>
              </string>
            </textSegment>
          </text>
          <text name="B_JOB_TITLE1" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.31250" y="0.00000" width="0.37500"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
          ...
          <text name="B_STATE_PROVINCE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.06250" y="0.00000" width="0.56250"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
          ...
          <text name="B_COUNTRY_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.62500" y="0.00000" width="0.50000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="5" bold="yes"
      ...
      <repeatingFrame name="R_G_JOB_TITLE" source="G_JOB_TITLE"
       printDirection="down" minWidowRecords="1" columnMode="no">
        <geometryInfo x="0.00000" y="0.18750" width="7.50000" height="0.87500"
        />
        ...
        <field name="F_JOB_TITLE" source="JOB_TITLE" minWidowLines="1"
         spacing="0" alignment="start">
          ...
          <geometryInfo x="1.87500" y="0.18750" width="1.06250"
           height="0.31250"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        ...
        <field name="F_full_name" source="full_name" minWidowLines="1"
         spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="0.06250" y="0.18750" width="0.81250"
           height="0.31250"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <field name="F_SALARY" source="SALARY" minWidowLines="1" spacing="0"
         alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="5.75000" y="0.18750" width="1.00000"
           height="0.31250"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <field name="F_COMMISSION_PCT" source="COMMISSION_PCT"
         minWidowLines="1" spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="6.75000" y="0.18750" width="0.62500"
           height="0.31250"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <field name="F_DEPARTMENT_NAME1" source="DEPARTMENT_NAME1"
         minWidowLines="1" spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="0.87500" y="0.18750" width="1.00000"
           height="0.31250"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        ...
        <field name="F_COUNTRY_NAME" source="COUNTRY_NAME" minWidowLines="1"
         spacing="0" alignment="start">
          <font face="helvetica" size="10"/>
          <geometryInfo x="3.81250" y="0.18750" width="1.06250"
           height="0.31250"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
      </repeatingFrame>
      <frame name="M_G_JOB_TITLE_FTR">
        <geometryInfo x="0.00000" y="1.12500" width="7.50000" height="0.56250"
        />
        <advancedLayout printObjectOnPage="lastPage"
         basePrintingOn="anchoringObject"/>
        <visualSettings fillPattern="transparent" fillBackgroundColor="Totals"/>
        <field name="F_CountJOB_TITLEPerReport"
         source="CountJOB_TITLEPerReport" minWidowLines="1" spacing="0"
         alignment="start">
          <font face="helvetica" size="10" bold="yes"/>
          <geometryInfo x="5.75000" y="1.18750" width="1.06250"
           height="0.43750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
      </frame>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwgreen" sectionTitle="employees details"/>
  <reportWebSettings>
  <![CDATA[]]>
  </reportWebSettings>
</report>
